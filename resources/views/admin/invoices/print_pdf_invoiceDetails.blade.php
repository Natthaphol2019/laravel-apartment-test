...
<head>
    ...
    <style>
        ...
        body {
            font-family: 'Sarabun-Regular';
            font-size: 12pt;
            /* ขนาดใหญ่ขึ้นเพื่อความชัดเจนตอนพิมพ์ */
            line-height: 1;
        }
...
<body>
    <div class="text-center">
        <h2 class="fw-bold" style="margin-bottom: 0;">ใบเสร็จรับเงิน</h2>
        <h3 class="fw-bold" style="margin-top: 5px;">{{ $apartment->name }}</h3>
    ...
    <table style="width: 100%; border: 1px solid black;">
        <tr>
            <td style="width: 60%; border-right: 1px solid black; padding: 10px; vertical-align: top; font-size: 12pt;" >
    ...
    <br>
    <br>
    <p style="font-size: 12pt; margin-top: 20px; margin-bottom: 10px; margin-left: 10%;">
        ผู้รับเงิน  ........................................................
    </p>
    <br>
    <br>
    ...
    <br>
    <p class="text-center" style="font-size: 12pt; margin-top: 20px;">

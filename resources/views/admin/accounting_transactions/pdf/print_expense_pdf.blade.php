...
<head>
    ...
    <style>
        ...
        body { font-family: 'Sarabun-Regular'; font-size: 12pt; line-height: 1.2; margin: 0; }
        ...
        .small-desc { font-size: 11pt; color: #555; }
    </style>
</head>
<body>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            @forelse($expenseByGroup as $catName => $transactions)
                ...
                <tr>
                    @if($index === 0)
                        <td rowspan="{{ $rowCount }}" class="text-center fw-bold bg-light">
                            {{ $catName }}
                        </td>
                    @endif
                    <td>

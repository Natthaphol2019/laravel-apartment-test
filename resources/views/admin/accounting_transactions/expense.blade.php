            ...
            <div class="row g-3 align-items-center">
                ...
                <div class="col-xl-7">
                    <form method="GET" class="row g-2 justify-content-end align-items-center">
                        ...
                        <div class="col-auto"><input type="date" name="date_start" class="form-control form-control-sm" value="{{ $startDate }}"></div>
                        <div class="col-auto"><label class="small fw-bold text-muted">ถึงวันที่</label></div>
                        <div class="col-auto"><input type="date" name="date_end" class="form-control form-control-sm" value="{{ $endDate }}"></div>
                        <div class="col-auto d-flex gap-1">
                            <button type="submit" class="btn btn-primary btn-sm px-3"><i class="bi bi-search"></i> ค้นหา</button>

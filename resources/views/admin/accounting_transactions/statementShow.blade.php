    ...
    <div class="container-fluid py-4 bg-white">
        <form method="GET" action="{{ route('admin.accounting_transactions.show') }}">
            ...
            <div class="text-center mb-4">
                <h2 class="fw-bold">เดือน {{ $displayDate }}</h2> {{-- ย้ายมาจาก Controller แล้ว --}}
                <div class="d-flex justify-content-center align-items-center gap-2 mt-2">
                    ...
                    <button type="submit" class="btn btn-dark btn-sm px-3 shadow-sm">ค้นหา</button>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead class="table-light border-bottom">
                            <tr class="text-secondary small">
                                ...
                                <th width="25%">หัวข้อรายการธุรกรรม</th>
                                <th class="text-center" width="8%">ห้อง</th>
                                <th width="12%">หมวดหมู่</th>
                                <th class="text-end" width="15%">จำนวนเงิน</th>
                                <th class="ps-4" width="13%">ผู้บันทึก</th>
                            ...
                            <tr class="bg-white">
                                ...
                                <td><input type="text" name="search_detail"
                                        ...
                                        placeholder="ฟิลเตอร์รายละเอียด" value="{{ $searchDetail }}"></td>

                                <td><input type="text" name="search_room"
                                        class="form-control form-control-sm bg-light border-0" placeholder="เลขห้อง"
                                        value="{{ $searchRoom }}"></td>
                                <td>
                                ...
                                <td>
                                    <select name="type_id" class="form-select form-select-sm bg-light border-0"
                                        onchange="this.form.submit()">
                                ...
                                <td class="text-center">
                                    <select name="filter_status"
                                        class="form-select form-select-sm bg-light border-0 text-center"
                                        onchange="this.form.submit()">
                        ...
                        <tbody class="">
                            @forelse($transactions as $t)
                                <tr class="border-bottom-0 {{ $t->status === 'void' ? 'table-danger' : '' }}"
                                    ...
                                    <td class="fw-bold">{{ $t->tenant->room->room_number ?? '-' }}</td>
        ...
        function viewDetail(id) {
            ...
            fetch(`accounting_transactions/readDetail/${id}`)
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6 text-end"><label class="text-muted small d-block">ห้อง</label><strong>${data.room}</strong></div>
                    
                    <div class="col-12"><hr class="my-2 border-light"></div>
                    
                    <div class="col-6"><label class="text-muted small d-block">จำนวนเงิน</label><h4 class="fw-bold text-primary mb-0">${data.amount} ฿</h4></div>
                    ...
                    <div class="col-12 mt-3">
                        <div class="d-flex justify-content-between small">
                            ...
                            <span class="text-muted italic">${data.payment_ref}</span>
                        </div>
                    </div>
                </div>
            `;

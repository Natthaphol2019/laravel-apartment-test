...
Route::prefix('admin')->middleware('auth:admin')->group(function () {
    ...
    // Test Floor plan นะจ๊ะ v.01
    Route::get('/floorplan', [AdminController::class, 'floorPlan'])->name('admin.floorplan');
    Route::post('/floorplan/save', [AdminController::class, 'saveLayout'])->name('admin.floorplan.save');
    // Route ใหม่สำหรับระบบจัดการห้อง (Smart System) -- test
    Route::get('/rooms/system', [AdminController::class, 'roomSystem'])->name('admin.rooms.system');
